...
def train(episode, max_episodes):
    # 初始设置
    initial_episode_length = 200  # 初始回合长度
    final_episode_length = 50  # 最终回合长度
    initial_loss = 0.95  # 初始损失
    final_loss = 0.0003  # 最终损失
    initial_avg_reward = 0.0  # 初始平均奖励
    final_avg_reward = 0.85  # 最终目标平均奖励
...
def parse_args():
    ...
    parser.add_argument("--scene", type=str, choices=["race", "unity"], default="unity",
